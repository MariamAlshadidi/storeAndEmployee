...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <form:form method="post" modelAttribute="employee">
      ...
      <div class="mb-3">
        ...
        <form:input path="age" type="number" cssClass="form-control" cssErrorClass="form-control is-invalid" id="age" aria-describedby="bookHelp" />
        <form:errors path="age" cssClass="invalid-feedback" />
      </div>
      
      <div class="mb-3">   
        <label class="form-label">Skill:</label>    
        <form:select path="skill" cssClass="form-control" cssErrorClass="form-control is-invalid"> 
       
          <option value="" > Select Skill </option>
    
             <form:option value="inventory specialist" label="inventory specialist"> 
               inventory specialist
             </form:option>
             
              <form:option value="sales agent" label="sales agent"> 
               sales agent
             </form:option>

        </form:select>  
        <form:errors path="skill" cssClass="text-danger"/>
       </div>
