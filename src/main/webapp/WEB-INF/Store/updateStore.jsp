...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <form:form modelAttribute="store" action="/store/edit/${store.id}" >
    <input type="hidden" name="_method" value="put">   
      ...
      <div class="mb-3">
        ...
        <form:input path="store_type" type="text" cssClass="form-control" cssErrorClass="form-control is-invalid" id="address" aria-describedby="bookHelp" />
        <form:errors path="store_type" cssClass="invalid-feedback" />
      </div>
      
      <div class="mb-3">   
        <label for="status" class="form-label">Status:</label>    
        <form:select path="status" cssClass="form-control" cssErrorClass="form-control is-invalid" id="status"> 
